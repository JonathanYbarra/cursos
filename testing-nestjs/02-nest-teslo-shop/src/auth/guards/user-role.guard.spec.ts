...
describe('UserRole Guard', () => {
    ...
    it('should return true if no roles are prensent', () => {
    ...
    it('should throw BadRequestExeption if user is not found', () => {
    ...
    it('should throw ForbiddenExeption if user lacks required role', () => {
        const user = {
            roles: ['user'],
            fullName: 'Jono'
        }
        ...
        expect(() => guard.canActivate(mockContext)).toThrow(`User ${user.fullName} need a valid role: [${validRoles}]`)
    })
